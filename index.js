...
// eslint-disable-next-line no-unused-vars
 let num1 = 0
let num2 = 18
console.log("value of num1 before change: "+num1)
if (num2 === 18) {
    num1 = 1
    console.log("value of num1 after change: "+num1)
}
...
*/
const kyle = "1999"
const gold = Number (kyle)
console.log("comes back a number "+ gold)
...
function annoyingSong(num){
    for (let bottles = num; bottles > 0; bottles-- ){
